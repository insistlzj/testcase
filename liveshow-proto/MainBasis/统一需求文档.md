...
本版从已逐项核对的当前context独立回读生成。系统概要优先，当前原型与结构化批注补充；问题条款移入配套需求待确认清单。

<!-- context-source:liveshow-proto/context/01-用户主播App-项目需求清单.md -->
# 用户App项目需求清单
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/01-用户主播App-项目需求清单.md:252 -->
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/01-用户主播App-项目需求清单.md:2688 -->

<!-- 风险条款转入需求待确认清单：liveshow-proto/context/01-用户主播App-项目需求清单.md:2691 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/01-用户主播App-项目需求清单.md:2693 -->


<!-- context-source:liveshow-proto/context/02-公会App-项目需求清单.md -->
# 公会App项目需求清单
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/02-公会App-项目需求清单.md:437 -->
...
<!-- context-source:liveshow-proto/context/03-管理后台-项目需求清单.md -->
# 管理后台项目需求清单
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:863 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:865 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:867 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:869 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:871 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:873 -->
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1183 -->
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1567 -->
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1709 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1711 -->
## 未登记页面 / admin-system-parameter-detail.html / admin-system-parameter-detail.html
页面入口：当前查看器未登记，不能推定正式入口。

<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1716 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1718 -->
## 未登记页面 / admin-system-audit.html / admin-system-audit.html
页面入口：当前查看器未登记，不能推定正式入口。

<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1723 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1725 -->
## 未登记页面 / admin-system-audit-detail.html / admin-system-audit-detail.html
页面入口：当前查看器未登记，不能推定正式入口。

<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1730 -->
...
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1744 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1746 -->

<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1749 -->
<!-- 风险条款转入需求待确认清单：liveshow-proto/context/03-管理后台-项目需求清单.md:1751 -->


<!-- context-source:liveshow-proto/context/原型页面目录结构.md -->
# 原型页面目录结构

<!-- prototype-modules:v1:start -->
## 原型模块归属
来源路径：liveshow-proto/prototype/index.html
来源 SHA-256：0c53f8a92ba25e34abafe2ccc37556779ba73a0cadbec185ad4117839750f595
...
| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 登录与注册 | liveshow-proto/prototype/pages/user/auth/auth-login-register.html | 直接页面 |
| 资料补全 | liveshow-proto/prototype/pages/user/auth/auth-profile-completion.html | 直接页面 |
| 手机号登录 | liveshow-proto/prototype/pages/user/auth/auth-phone-login.html | 直接页面 |
| 选择国家/地区 | liveshow-proto/prototype/pages/user/auth/auth-country-select.html | 直接页面 |
| 邮箱登录 | liveshow-proto/prototype/pages/user/auth/auth-email-login.html | 直接页面 |

#### 首页与福利

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 首页 | liveshow-proto/prototype/pages/user/home/live-plaza.html | 直接页面 |
| 主播榜 | liveshow-proto/prototype/pages/user/home/host-ranking.html | 直接页面 |
| 贡献榜（平台） | liveshow-proto/prototype/pages/user/home/contribution-ranking.html | 直接页面 |
| 搜索 | liveshow-proto/prototype/pages/user/home/search.html | 直接页面 |
| 搜索结果 | liveshow-proto/prototype/pages/user/home/search-results.html | 直接页面 |
| 充值福利 | liveshow-proto/prototype/pages/user/home/welfare-center.html | 直接页面 |
| 全部任务 | liveshow-proto/prototype/pages/user/home/all-tasks.html | 直接页面 |
| 邀请好友 | liveshow-proto/prototype/pages/user/home/invite-friends.html | 直接页面 |

#### 直播

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 直播间-观众 | liveshow-proto/prototype/pages/user/live/live-room.html | 直接页面 |
| 举报用户 | liveshow-proto/prototype/pages/user/live/live-room-user-report.html | 直接页面 |
| 直播间-主播 | liveshow-proto/prototype/pages/user/live/live-room-host.html | 直接页面 |
| 直播间-主播-密码房 | liveshow-proto/prototype/pages/user/live/live-room-host-password.html | 直接页面 |
| 直播间-连麦中-主播 | liveshow-proto/prototype/pages/user/live/live-room-cohost-active.html | 直接页面 |
| 直播结束页（观众） | liveshow-proto/prototype/pages/user/live/live-end-viewer.html | 直接页面 |
| 直播结束页（主播） | liveshow-proto/prototype/pages/user/live/live-end-host.html | 直接页面 |

#### 消息与社交

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 消息 | liveshow-proto/prototype/pages/user/social/message-center.html | 直接页面 |
| 系统通知 | liveshow-proto/prototype/pages/user/social/system-notifications.html | 直接页面 |
| 1 对 1 私信 | liveshow-proto/prototype/pages/user/social/direct-message.html | 直接页面 |
| 粉丝团群聊 | liveshow-proto/prototype/pages/user/social/fan-group-chat.html | 直接页面 |
| 群管理（成员） | liveshow-proto/prototype/pages/user/social/group-manage-member.html | 直接页面 |
| 群管理（群主） | liveshow-proto/prototype/pages/user/social/group-manage-owner.html | 直接页面 |
| 单聊设置 | liveshow-proto/prototype/pages/user/social/chat-settings.html | 直接页面 |
| 好友列表 | liveshow-proto/prototype/pages/user/social/friend-list.html | 直接页面 |
| 粉丝列表 | liveshow-proto/prototype/pages/user/social/follower-list.html | 直接页面 |
| 互动通知 | liveshow-proto/prototype/pages/user/social/interaction-notifications.html | 直接页面 |
| 用户主页 | liveshow-proto/prototype/pages/user/social/user-home.html | 直接页面 |
| 主播主页 | liveshow-proto/prototype/pages/user/social/host-home.html | 直接页面 |
| 举报直播间 | liveshow-proto/prototype/pages/user/live/live-room-report.html | 直接页面 |
| 主播礼物展馆 | liveshow-proto/prototype/pages/user/social/host-gift-gallery.html | 直接页面 |

#### 我的

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 我的 | liveshow-proto/prototype/pages/user/profile/profile.html | 直接页面 |
| 资料编辑 | liveshow-proto/prototype/pages/user/profile/profile-edit.html | 直接页面 |
| 联系客服 | liveshow-proto/prototype/pages/user/profile/customer-service.html | 直接页面 |
| 我的关注 | liveshow-proto/prototype/pages/user/profile/my-following.html | 直接页面 |
| 我的装扮 | liveshow-proto/prototype/pages/user/profile/my-decoration.html | 直接页面 |
| 设置 | liveshow-proto/prototype/pages/user/profile/settings.html | 直接页面 |
| 设置密码 | liveshow-proto/prototype/pages/user/profile/account-password-set.html | 直接页面 |
| 修改密码 | liveshow-proto/prototype/pages/user/profile/account-password-change.html | 直接页面 |
| 忘记密码 | liveshow-proto/prototype/pages/user/profile/account-password-reset.html | 直接页面 |
| 黑名单管理 | liveshow-proto/prototype/pages/user/profile/blacklist-management.html | 直接页面 |
| 我的粉丝团 | liveshow-proto/prototype/pages/user/fan-club/my-fan-clubs.html | 直接页面 |
| 贡献榜 | liveshow-proto/prototype/pages/user/fan-club/fan-contribution-ranking.html | 直接页面 |
| 申请成为主播 | liveshow-proto/prototype/pages/user/host/host-center-pending.html | 直接页面 |

#### 公会关系

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 公会中心 | liveshow-proto/prototype/pages/user/guild/guild-management.html | 直接页面 |
| 填写申请单 | liveshow-proto/prototype/pages/user/guild/guild-application-form.html | 直接页面 |
| 我的公会 | liveshow-proto/prototype/pages/user/guild/guild-application-records.html | 直接页面 |
| 公会详情 | liveshow-proto/prototype/pages/user/guild/guild-detail.html | 直接页面 |
| 申请退出公会 | liveshow-proto/prototype/pages/user/guild/guild-leave-application.html | 直接页面 |

#### 主播中心

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 主播中心 | liveshow-proto/prototype/pages/user/host/host-center.html | 直接页面 |
| 房管管理 | liveshow-proto/prototype/pages/user/host/moderator-management.html | 直接页面 |
| 公会通知 | liveshow-proto/prototype/pages/user/host/host-guild-notifications.html | 直接页面 |
| 开播设置 | liveshow-proto/prototype/pages/user/host/start-live-settings.html | 直接页面 |
| 粉丝列表 | liveshow-proto/prototype/pages/user/host/fan-list.html | 直接页面 |
| 粉丝团 | liveshow-proto/prototype/pages/user/host/fan-club.html | 直接页面 |
| 粉丝团设置 | liveshow-proto/prototype/pages/user/host/fan-club-settings.html | 直接页面 |
| 直播数据 | liveshow-proto/prototype/pages/user/host/live-data.html | 直接页面 |
| 直播记录 | liveshow-proto/prototype/pages/user/host/live-records.html | 直接页面 |
| 分成记录 | liveshow-proto/prototype/pages/user/host/income-sharing.html | 直接页面 |

#### 钱包与账单

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 余额充值 | liveshow-proto/prototype/pages/user/wallet/recharge.html | 直接页面 |
| 余额明细 | liveshow-proto/prototype/pages/user/wallet/balance-detail.html | 直接页面 |
| 充值订单详情 | liveshow-proto/prototype/pages/user/wallet/order-income-detail.html | 直接页面 |
| 支出订单详情 | liveshow-proto/prototype/pages/user/wallet/order-expense-detail.html | 直接页面 |
...
| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 公会登录 | liveshow-proto/prototype/pages/guild/auth/guild-login.html | 直接页面 |
| 选择公会 | liveshow-proto/prototype/pages/guild/auth/guild-switch.html | 直接页面 |
| 首页 | liveshow-proto/prototype/pages/guild/home/guild-home.html | 直接页面 |
| 通知消息 | liveshow-proto/prototype/pages/guild/home/guild-notifications.html | 直接页面 |
| 通知详情 | liveshow-proto/prototype/pages/guild/home/guild-notification-detail.html | 直接页面 |

#### 主播管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 入会申请 | liveshow-proto/prototype/pages/guild/approval/guild-join-review.html | 直接页面 |
| 入会申请详情 | liveshow-proto/prototype/pages/guild/approval/guild-join-review-detail.html | 直接页面 |
| 退会申请 | liveshow-proto/prototype/pages/guild/approval/guild-leave-review.html | 直接页面 |
| 退会申请详情 | liveshow-proto/prototype/pages/guild/approval/guild-leave-review-detail.html | 直接页面 |
| 主播列表 | liveshow-proto/prototype/pages/guild/people/guild-member-list.html | 直接页面 |
| 主播业绩 | liveshow-proto/prototype/pages/guild/people/guild-host-list.html | 直接页面 |
| 主播数据 | liveshow-proto/prototype/pages/guild/data/guild-host-summary.html | 直接页面 |
| 主播主页 | liveshow-proto/prototype/pages/guild/people/guild-host-detail.html | 直接页面 |

#### 运营工具

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 运营消息 | liveshow-proto/prototype/pages/guild/operations/guild-messages.html | 直接页面 |
| 新建运营消息 | liveshow-proto/prototype/pages/guild/operations/guild-message-compose.html | 直接页面 |
| 选择主播 | liveshow-proto/prototype/pages/guild/operations/guild-host-select.html | 直接页面 |
| 消息详情 | liveshow-proto/prototype/pages/guild/operations/guild-message-detail.html | 直接页面 |
| 运营账号 | liveshow-proto/prototype/pages/guild/operations/guild-operation-accounts.html | 直接页面 |
| 创建运营账号 | liveshow-proto/prototype/pages/guild/operations/guild-operation-account-compose.html | 直接页面 |
| 运营账号主页 | liveshow-proto/prototype/pages/guild/operations/guild-operation-account-detail.html | 直接页面 |
| 送礼记录 | liveshow-proto/prototype/pages/guild/operations/guild-operation-gift-records.html | 直接页面 |
| 选择运营账号（多选） | liveshow-proto/prototype/pages/guild/operations/guild-operation-account-select.html | 直接页面 |

#### 公会管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 公会资料 | liveshow-proto/prototype/pages/guild/management/guild-profile.html | 直接页面 |
| 账号设置 | liveshow-proto/prototype/pages/guild/management/guild-settings.html | 直接页面 |
| 修改密码 | liveshow-proto/prototype/pages/guild/management/guild-password.html | 直接页面 |

#### 数据与收益

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 公会业绩 | liveshow-proto/prototype/pages/guild/data/guild-income.html | 直接页面 |
| 每日 | liveshow-proto/prototype/pages/guild/data/guild-income-day-detail.html | 直接页面 |
| 直播记录 | liveshow-proto/prototype/pages/guild/data/guild-host-data.html | 直接页面 |
| 直播场次详情 | liveshow-proto/prototype/pages/guild/data/guild-live-gift-detail.html | 直接页面 |
| 违规记录 | liveshow-proto/prototype/pages/guild/data/guild-all-violations.html | 直接页面 |
| 主播分成记录 | liveshow-proto/prototype/pages/guild/data/guild-share-ledger.html | 直接页面 |
| 公会分成记录 | liveshow-proto/prototype/pages/guild/data/guild-share-income.html | 直接页面 |
| 选择主播（多选） | liveshow-proto/prototype/pages/guild/data/guild-violation-host-select.html | 直接页面 |
...
| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 工作台 | liveshow-proto/prototype/pages/admin/dashboard/admin-dashboard.html | 直接页面 |

#### 用户管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 用户列表 | liveshow-proto/prototype/pages/admin/user/admin-user-list.html | 直接页面 |
| 用户详情 | liveshow-proto/prototype/pages/admin/user/admin-user-detail.html | 关联详情页 |

#### 主播管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 主播审核 | liveshow-proto/prototype/pages/admin/host/admin-host-review.html | 直接页面 |
| 审核详情 | liveshow-proto/prototype/pages/admin/host/admin-host-review-detail.html | 关联详情页 |
| 主播列表 | liveshow-proto/prototype/pages/admin/host/admin-host-list.html | 直接页面 |
| 主播详情 | liveshow-proto/prototype/pages/admin/host/admin-host-detail.html | 关联详情页 |
| 直播场次 | liveshow-proto/prototype/pages/admin/host/admin-live-management.html | 直接页面 |
| 直播详情 | liveshow-proto/prototype/pages/admin/host/admin-live-detail.html | 关联详情页 |
| 巡房排班 | liveshow-proto/prototype/pages/admin/host/admin-inspection-schedule.html | 直接页面 |
| 新建排班 | liveshow-proto/prototype/pages/admin/host/admin-inspection-schedule-create.html | 关联详情页 |
| 排班详情 | liveshow-proto/prototype/pages/admin/host/admin-inspection-schedule-detail.html | 关联详情页 |
| 内容审核 | liveshow-proto/prototype/pages/admin/content/admin-content-audit.html | 直接页面 |
| 内容审核详情 | liveshow-proto/prototype/pages/admin/content/admin-content-audit-detail.html | 关联详情页 |

#### 举报处理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 账号违规 | liveshow-proto/prototype/pages/admin/content/admin-account-violation.html | 直接页面 |
| 直播间违规 | liveshow-proto/prototype/pages/admin/content/admin-report-handling.html | 直接页面 |
| 举报详情 | liveshow-proto/prototype/pages/admin/content/admin-report-detail.html | 关联详情页 |
| 违规类型 | liveshow-proto/prototype/pages/admin/content/admin-violation-types.html | 直接页面 |
| 违规类型编辑 | liveshow-proto/prototype/pages/admin/content/admin-violation-type-detail.html | 关联详情页 |

#### 公会管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 公会列表 | liveshow-proto/prototype/pages/admin/guild/admin-guild-list.html | 直接页面 |
| 公会详情 | liveshow-proto/prototype/pages/admin/guild/admin-guild-detail.html | 关联详情页 |

#### 礼物道具

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 普通礼物 | liveshow-proto/prototype/pages/admin/gifts/admin-gift-list.html | 直接页面 |
| 礼物详情 | liveshow-proto/prototype/pages/admin/gifts/admin-gift-detail.html | 关联详情页 |
| 定制礼物 | liveshow-proto/prototype/pages/admin/gifts/admin-custom-gift.html | 直接页面 |
| 幸运礼物 | liveshow-proto/prototype/pages/admin/gifts/admin-lucky-gift-config.html | 直接页面 |
| 幸运礼物编辑 | liveshow-proto/prototype/pages/admin/gifts/admin-lucky-gift-detail.html | 关联详情页 |
| 道具配置 | liveshow-proto/prototype/pages/admin/gifts/admin-prop-list.html | 直接页面 |
| 道具详情 | liveshow-proto/prototype/pages/admin/gifts/admin-prop-detail.html | 关联详情页 |
| 购买份数配置 | liveshow-proto/prototype/pages/admin/gifts/admin-gift-send-count-rules.html | 直接页面 |
| 购买份数配置详情 | liveshow-proto/prototype/pages/admin/gifts/admin-gift-send-count-rule-detail.html | 关联详情页 |

#### 运营配置

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 展位配置 | liveshow-proto/prototype/pages/admin/operations/admin-placement-config.html | 直接页面 |
| 展示素材编辑 | liveshow-proto/prototype/pages/admin/operations/admin-placement-detail.html | 关联详情页 |
| 推送管理 | liveshow-proto/prototype/pages/admin/operations/admin-push-management.html | 直接页面 |
| 推送编辑 | liveshow-proto/prototype/pages/admin/operations/admin-push-detail.html | 关联详情页 |
| 充值套餐 | liveshow-proto/prototype/pages/admin/operations/admin-recharge-package.html | 直接页面 |
| 充值套餐编辑 | liveshow-proto/prototype/pages/admin/operations/admin-recharge-package-detail.html | 关联详情页 |
| 任务配置 | liveshow-proto/prototype/pages/admin/operations/admin-task-config.html | 直接页面 |
| 任务编辑 | liveshow-proto/prototype/pages/admin/operations/admin-task-detail.html | 关联详情页 |
| 公会推荐 | liveshow-proto/prototype/pages/admin/operations/admin-guild-recommendation.html | 直接页面 |
| 公会推荐编辑 | liveshow-proto/prototype/pages/admin/operations/admin-guild-recommendation-detail.html | 关联详情页 |
| 直播类型 | liveshow-proto/prototype/pages/admin/operations/admin-live-type.html | 直接页面 |
| 直播房型 | liveshow-proto/prototype/pages/admin/operations/admin-feature-switch.html | 直接页面 |
| 门票价格档位 | liveshow-proto/prototype/pages/admin/operations/admin-ticket-price-level.html | 关联详情页 |
| 门票价格档位编辑 | liveshow-proto/prototype/pages/admin/operations/admin-ticket-price-level-detail.html | 关联详情页 |
| 敏感词库 | liveshow-proto/prototype/pages/admin/operations/admin-sensitive-words.html | 直接页面 |
| 敏感词编辑 | liveshow-proto/prototype/pages/admin/operations/admin-sensitive-words-detail.html | 关联详情页 |
| 等级配置 | liveshow-proto/prototype/pages/admin/operations/admin-level-config.html | 直接页面 |

#### 订单管理

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 充值订单 | liveshow-proto/prototype/pages/admin/orders/admin-recharge-order.html | 直接页面 |
| 充值订单详情 | liveshow-proto/prototype/pages/admin/orders/admin-recharge-order-detail.html | 关联详情页 |
| 消费订单 | liveshow-proto/prototype/pages/admin/orders/admin-consumption-order.html | 直接页面 |
| 消费订单详情 | liveshow-proto/prototype/pages/admin/orders/admin-consumption-order-detail.html | 关联详情页 |
| 退款订单 | liveshow-proto/prototype/pages/admin/orders/admin-refund-order.html | 直接页面 |

#### 财务分成

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 主播分成记录 | liveshow-proto/prototype/pages/admin/finance/admin-settlement-record.html | 直接页面 |
| 主播分成记录详情 | liveshow-proto/prototype/pages/admin/finance/admin-settlement-record-detail.html | 关联详情页 |
| 主播账户余额 | liveshow-proto/prototype/pages/admin/finance/admin-host-account-balance.html | 直接页面 |
| 主播余额变更记录 | liveshow-proto/prototype/pages/admin/finance/admin-host-balance-change-record.html | 关联详情页 |
| 公会分成记录 | liveshow-proto/prototype/pages/admin/finance/admin-guild-settlement-record.html | 直接页面 |
| 公会分成记录详情 | liveshow-proto/prototype/pages/admin/finance/admin-guild-settlement-record-detail.html | 关联详情页 |
| 公会账户余额 | liveshow-proto/prototype/pages/admin/finance/admin-guild-account-balance.html | 直接页面 |
| 公会余额变更记录 | liveshow-proto/prototype/pages/admin/finance/admin-guild-balance-change-record.html | 关联详情页 |

#### 数据分析

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 报表中心 | liveshow-proto/prototype/pages/admin/analytics/admin-report-center.html | 直接页面 |
| 数据概览 | liveshow-proto/prototype/pages/admin/analytics/admin-data-overview.html | 直接页面 |
| 每日统计 | liveshow-proto/prototype/pages/admin/analytics/admin-daily-statistics.html | 直接页面 |
| 用户活跃汇总（每日） | liveshow-proto/prototype/pages/admin/analytics/admin-user-active-statistics.html | 直接页面 |
| 主播活跃汇总（每日） | liveshow-proto/prototype/pages/admin/analytics/admin-host-statistics.html | 直接页面 |
| 直播间互动汇总（每日） | liveshow-proto/prototype/pages/admin/analytics/admin-live-statistics.html | 直接页面 |
| 直播记录明细报表 | liveshow-proto/prototype/pages/admin/analytics/admin-host-live-record-report.html | 直接页面 |
| 充值消费汇总（每日） | liveshow-proto/prototype/pages/admin/analytics/admin-recharge-statistics.html | 直接页面 |
| 充值用户分层汇总（每日） | liveshow-proto/prototype/pages/admin/analytics/admin-user-activity-statistics.html | 直接页面 |
| 月度收益支出汇总 | liveshow-proto/prototype/pages/admin/analytics/admin-monthly-income-expense.html | 直接页面 |
| 主播业绩分成报表 | liveshow-proto/prototype/pages/admin/analytics/admin-monthly-host-share.html | 直接页面 |
| 主播礼物打赏明细报表 | liveshow-proto/prototype/pages/admin/analytics/admin-monthly-host-earnings.html | 直接页面 |
| 用户消费汇总报表 | liveshow-proto/prototype/pages/admin/analytics/admin-monthly-viewer-consumption.html | 直接页面 |
| 礼物消费汇总报表 | liveshow-proto/prototype/pages/admin/analytics/admin-monthly-gift-sales.html | 直接页面 |
| 消费订单明细 | liveshow-proto/prototype/pages/admin/analytics/admin-consumption-order-detail-report.html | 直接页面 |
| 退款订单明细 | liveshow-proto/prototype/pages/admin/analytics/admin-refund-order-detail-report.html | 直接页面 |
| 充值订单明细 | liveshow-proto/prototype/pages/admin/analytics/admin-recharge-order-detail-report.html | 直接页面 |

#### 运营账号

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 账号列表 | liveshow-proto/prototype/pages/admin/accounts/admin-operation-accounts.html | 直接页面 |
| 运营账号主页 | liveshow-proto/prototype/pages/admin/accounts/admin-operation-account-detail.html | 关联详情页 |
| 发放记录 | liveshow-proto/prototype/pages/admin/accounts/admin-operation-issue-records.html | 直接页面 |
| 送礼记录 | liveshow-proto/prototype/pages/admin/accounts/admin-operation-gift-records.html | 直接页面 |
| 额度限制 | liveshow-proto/prototype/pages/admin/accounts/admin-operation-guild-controls.html | 直接页面 |

#### 系统配置

| 页面名称 | 页面路径 | 登记方式 |
| --- | --- | --- |
| 后台账号 | liveshow-proto/prototype/pages/admin/system/admin-system-account.html | 直接页面 |
| 账号编辑 | liveshow-proto/prototype/pages/admin/system/admin-system-account-detail.html | 关联详情页 |
| 角色管理 | liveshow-proto/prototype/pages/admin/system/admin-system-role.html | 直接页面 |
| 角色编辑 | liveshow-proto/prototype/pages/admin/system/admin-system-role-detail.html | 关联详情页 |
<!-- prototype-modules:v1:end -->


<!-- context-source:liveshow-proto/context/系统概要 .md -->
# 系统概要
...
|管理运营账号与虚拟金币|启停运营账号，管理公会管理账号权限，限制虚拟金币额度发放。|
...
|删除好友|解除双方的好友关系，删除聊天列表中对话框及聊天记录|\-|
|举报|生成举报工单|\-|
...
- 任一邀请被接受并成功建立连麦后，双方发出的邀请和收到的邀请均失效。
...
|取消邀请|已发起的邀请失效|
|拒绝邀请|已发起的邀请失效|
|接受邀请|成功建立连麦后，双方发出的邀请和收到的邀请均失效|
|被接受邀请|成功建立连麦后，双方发出的邀请和收到的邀请均失效|
...
- 在各类观众名单中，运营账号只进入在线观众列表，本场贡献值始终为 0；不进入主播榜、贡献榜、重点在线观众等任何榜单或排行。

- 运营账号使用虚拟金币送礼只计入直播间公屏消息和礼物效果，不形成主播收益或分成。


#### 3\.7\.4 运营账号功能白名单

目的是，限制运营账号：赠送幸运礼物、充值、加入粉丝团、购买装扮、绑定邮箱/手机号、注销登录。

|首页|福利|消息|我的|
|---|---|---|---|
|✅<br>全部功能|✅<br>只能进入一级页|✅<br>消息、好友|✅<br>编辑资料、设置（除绑定手机号、绑定邮箱、注销登录外）；<br>关注、粉丝、好友；黑名单、联系客服；|
|\-\-|❌<br>进入一级页，点击其中任意功能入口，提示“运营账号无法操作”|❌<br>粉丝团<br>点击提示“运营账号无法操作”|❌<br>设置（绑定手机号、绑定邮箱、注销登录）；<br>充值、我的装扮、粉丝团、邀请奖励、开始直播、主播中心、公会中心；<br>点击提示“运营账号无法操作”|
