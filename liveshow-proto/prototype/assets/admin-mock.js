...
window.LUMA_ADMIN_MOCK = {
  ...
  records: {
    '88231007': {
      ...
      violations: [
        ...
        { type: '私信骚扰', action: '禁言 24 小时', reason: '举报复核成立', time: '2026-07-26 18:40' }
      ]
    },
    '88225190': {
      recharges: [],
      ...
      relationships: [],
      violations: [
        { type: '欺诈交易', action: '永久封禁', reason: '多笔异常支付及拒付', time: '2026-07-13 09:20' }
      ]
    }
  },
  rechargeOrders: [
  ...
  hostViolationRecords: [
    ...
    { recordNo: 'HV202607250009', hostId: '77205884', hostName: 'Lala', initials: 'L', guild: 'Star House', type: '严重违规', sourceNo: 'AU2607250019', action: '永久封禁', reason: '多次严重违规且申诉不成立', operator: '后台管理员', occurredAt: '2026-07-25 09:08' },
  ...
  appeals: [
    { appealNo: 'AP202608040003', appellantId: '88225190', name: 'Siti Rahma', initials: 'SR', identity: '用户', accountStatus: '已封禁', banReason: '多笔异常支付及拒付', banDuration: '永久', banScope: '登录、发言、送礼', appealReason: '支付账号由家人共同使用，希望重新核查交易归属。', evidence: ['支付账户说明.pdf', '交易凭证-01.jpg'], submittedAt: '2026-08-04 09:42', status: 'pending', result: '', record: null },
    { appealNo: 'AP202608030018', appellantId: '77210411', name: 'Sari', initials: 'S', identity: '主播', accountStatus: '直播权限封禁', banReason: '直播中出现违规引流信息', banDuration: '7 天', banScope: '直播', appealReason: '违规信息来自连麦用户，主播发现后已立即断开连麦。', evidence: ['直播回放片段.mp4', '情况说明.pdf'], submittedAt: '2026-08-03 22:16', status: 'pending', result: '', record: null },
    { appealNo: 'AP202608020027', appellantId: '88229841', name: 'Nadia Putri', initials: 'NP', identity: '用户', accountStatus: '禁言中', banReason: '公屏连续发布攻击性内容', banDuration: '7 天', banScope: '发言', appealReason: '账号当时被他人临时使用，已修改密码并开启设备保护。', evidence: ['设备登录记录.png'], submittedAt: '2026-08-02 18:30', status: 'pending', result: '', record: null },
    { appealNo: 'AP202608010011', appellantId: '77208635', name: 'Dewi', initials: 'D', identity: '主播', accountStatus: '正常', banReason: '直播画面误触发机审', banDuration: '3 天', banScope: '直播', appealReason: '告警画面为舞台灯光造成的误判，请求人工复核。', evidence: ['现场全景录像.mp4'], submittedAt: '2026-08-01 14:08', status: 'success', result: '恢复账号', record: { result: '恢复账号', conclusion: '人工复核未发现违规内容，撤销原直播权限封禁。', operator: 'Maya Chen', processedAt: '2026-08-02 10:25' } },
    { appealNo: 'AP202607300006', appellantId: '88227653', name: 'Rizky Maulana', initials: 'RM', identity: '用户', accountStatus: '已封禁', banReason: '私信骚扰多名用户', banDuration: '30 天', banScope: '登录、发言', appealReason: '已向相关用户道歉，希望缩短封禁时间。', evidence: ['道歉记录截图.jpg'], submittedAt: '2026-07-30 08:51', status: 'maintained', result: '维持封禁', record: { result: '维持封禁', conclusion: '多名用户举报且证据完整，原处置符合规则。', operator: '后台管理员', processedAt: '2026-07-30 16:40' } },
    { appealNo: 'AP202607280014', appellantId: '77209318', name: 'Maya', initials: 'M', identity: '主播', accountStatus: '正常', banReason: '门票房内容与标题不符', banDuration: '7 天', banScope: '直播', appealReason: '直播因设备故障中断，非故意提供不符内容。', evidence: ['设备维修单.pdf'], submittedAt: '2026-07-28 19:20', status: 'success', result: '恢复账号', record: { result: '恢复账号', conclusion: '设备故障材料有效，撤销原处置并恢复直播权限。', operator: 'Maya Chen', processedAt: '2026-07-29 11:12' } },
    { appealNo: 'AP202607260009', appellantId: '88218339', name: 'Bima Saputra', initials: 'BS', identity: '用户', accountStatus: '已封禁', banReason: '多次发布虚假活动信息', banDuration: '永久', banScope: '登录、发言、送礼', appealReason: '发布内容来自第三方转发，不清楚信息真实性。', evidence: [], submittedAt: '2026-07-26 12:34', status: 'maintained', result: '维持封禁', record: { result: '维持封禁', conclusion: '历史存在三次同类违规，维持永久封禁。', operator: '后台管理员', processedAt: '2026-07-27 09:18' } }
  ],
  hosts: [
  ...
  livePermissions: [
    ...
    { hostId: '77209318', name: 'Maya', initials: 'M', guild: 'Aurora Guild', certStatus: 'approved', liveStatus: 'live', platformPermission: 'enabled', guildPermission: 'enabled', locked: false, reason: '公会申请恢复直播权限', changedAt: '2026-08-02 10:25', changes: [{ before: '已关闭', after: '已开通', reason: '申诉复核通过', operator: 'Maya Chen', time: '2026-08-02 10:25' }] },
    ...
    { hostId: '77205884', name: 'Lala', initials: 'L', guild: 'Star House', certStatus: 'approved', liveStatus: 'offline', platformPermission: 'disabled', guildPermission: 'disabled', locked: true, reason: '账号永久封禁', changedAt: '2026-07-25 09:08', changes: [{ before: '已开通', after: '已关闭 / 已锁定', reason: '账号永久封禁', operator: '后台管理员', time: '2026-07-25 09:08' }] }
  ],
  liveSessions: [
  ...
  reports: [
    { reportNo: 'RA2608040218', violationScope: 'account', reporterId: '88231007', reporterName: 'Andi Pratama', targetType: '用户账号', targetId: '88224719', targetName: 'Raka Wijaya', hostId: '88224719', hostName: 'Raka Wijaya', hostInitials: 'R', accountRole: '用户', reportType: '色情低俗', evidence: ['私信截图-01.jpg'], description: '被举报账号通过私信发送色情低俗内容。', related: '账号 88224719', submittedAt: '2026-08-04 13:18', status: 'pending', result: '待处理', record: null },
    { reportNo: 'RA2608040193', violationScope: 'account', reporterId: '88220472', reporterName: 'Aulia Safitri', targetType: '主播账号', targetId: '77208635', targetName: 'Dewi', hostId: '77208635', hostName: 'Dewi', hostInitials: 'D', accountRole: '主播', reportType: '涉及宗教政治', evidence: ['聊天记录.png'], description: '被举报账号私信传播涉及宗教政治的不当内容。', related: '主播账号 77208635', submittedAt: '2026-08-04 12:36', status: 'processing', result: '处理中', record: null },
    { reportNo: 'RA2608030114', violationScope: 'account', reporterId: '88227653', reporterName: 'Rizky Maulana', targetType: '用户账号', targetId: '88216508', targetName: 'Bagus Setiawan', hostId: '88216508', hostName: 'Bagus Setiawan', hostInitials: 'B', accountRole: '用户', reportType: '暴恐血腥', evidence: ['主页截图.jpg'], description: '账号主页发布暴恐血腥内容。', related: '账号 88216508', submittedAt: '2026-08-03 21:45', status: 'resolved', result: '封禁', record: { action: '封禁', reason: '发布暴恐血腥内容证据明确', result: '举报成立', operator: '后台管理员', time: '2026-08-04 09:25' } },
    { reportNo: 'RA2608020081', violationScope: 'account', reporterId: '88218339', reporterName: 'Bima Saputra', targetType: '用户账号', targetId: '88230411', targetName: 'Putri Lestari', hostId: '88230411', hostName: 'Putri Lestari', hostInitials: 'P', accountRole: '用户', reportType: '未成年有害', evidence: ['头像截图.jpg'], description: '账号头像包含可能危害未成年人的不适宜内容。', related: '账号 88230411', submittedAt: '2026-08-02 20:10', status: 'resolved', result: '警告', record: { action: '警告', reason: '已要求更换有害未成年人内容', result: '部分成立', operator: 'Maya Chen', time: '2026-08-03 10:20' } },
    { reportNo: 'RA2608010045', violationScope: 'account', reporterId: '88229841', reporterName: 'Nadia Putri', targetType: '主播账号', targetId: '77207152', targetName: 'Ayu', hostId: '77207152', hostName: 'Ayu', hostInitials: 'A', accountRole: '主播', reportType: '其他', evidence: ['私信录屏.mp4'], description: '被举报账号多次发送骚扰私信。', related: '主播账号 77207152', submittedAt: '2026-08-01 18:40', status: 'resolved', result: '禁言', record: { action: '禁言', reason: '骚扰行为成立', result: '举报成立', operator: 'Nina', time: '2026-08-01 19:12' } },
