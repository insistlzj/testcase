...
window.LUMA_ADMIN_MOCK = {
  violationTypes: typeof window.LUMA_READ_VIOLATION_TYPES === 'function'
    ? window.LUMA_READ_VIOLATION_TYPES()
    : [
        { id: 'VT001', name: '色情低俗', sort: 1, protected: true, enabled: true, updatedAt: '2026-09-01 09:20' },
        { id: 'VT002', name: '涉及宗教政治', sort: 2, protected: true, enabled: true, updatedAt: '2026-09-01 09:18' },
        { id: 'VT003', name: '暴恐血腥', sort: 3, protected: true, enabled: true, updatedAt: '2026-09-01 09:16' },
        { id: 'VT004', name: '未成年有害', sort: 4, protected: false, enabled: true, updatedAt: '2026-09-01 09:14' },
        { id: 'VT005', name: '其它', sort: 5, protected: false, enabled: true, updatedAt: '2026-09-01 09:12' }
      ],
  reportTypes: Array.isArray(window.LUMA_REPORT_TYPES)
    ? window.LUMA_REPORT_TYPES
    : ['色情低俗', '涉及宗教政治', '暴恐血腥', '未成年有害', '其它'],
  users: [
    { id: '88231007', name: 'Andi Pratama', initials: 'AP', isHost: true, login: '+62 812-7812-3066', registeredAt: '2026-07-28 14:32', level: 12, recharge: 2580000, spend: 1846200, balance: 12580, guild: 'Aurora Agency', status: 'normal', region: 'Jakarta', gender: '男', birthday: '1998-05-16', signature: '享受每一次直播。' },
    ...
    { id: '88225190', name: 'Siti Rahma', initials: 'SR', isHost: true, login: 'Apple · siti.rahma@icloud.com', registeredAt: '2026-07-12 11:45', level: 41, recharge: 23600000, spend: 22890000, balance: 192400, guild: 'Aurora Agency', status: 'banned', region: 'Medan', gender: '女', birthday: '1996-08-09', signature: '保持简单。' },
  ...
  hostFollowerChangeRecords: [
    { recordNo: 'FC2026080704621', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88234521', userName: 'Putri Ananda', type: '新增关注', source: '直播间', occurredAt: '2026-08-07 22:28' },
    { recordNo: 'FC2026080704518', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', userId: '88234386', userName: 'Raka Pratama', type: '新增关注', source: '主播主页', occurredAt: '2026-08-07 21:42' },
    ...
    { recordNo: 'FC2026080704164', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88227653', userName: 'Rizky Maulana', type: '新增关注', source: '直播间', occurredAt: '2026-08-07 19:36' },
  ...
  hostViolationRecords: [
    ...
    { recordNo: 'HV202607180031', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', type: '标题不规范', sourceNo: 'LS2607180042', action: '警告', reason: '标题含夸大表述', operator: 'Rafi', occurredAt: '2026-07-18 21:35' }
  ],
  liveViewerRecords: [
    { recordNo: 'VW2026080708421', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88231007', userName: 'Andi Pratama', userInitials: 'AP', source: '直播广场', enteredAt: '2026-08-07 21:58', leftAt: '2026-08-07 22:26', duration: 1680, device: 'Android' },
    ...
    { recordNo: 'VW2026080708104', sessionId: 'LS2608070031', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', userId: '88227653', userName: 'Rizky Maulana', userInitials: 'RM', source: '推送通知', enteredAt: '2026-08-07 21:08', leftAt: '2026-08-07 21:17', duration: 540, device: 'Android' },
    ...
    { recordNo: 'VW2026080707193', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88218339', userName: 'Bima Saputra', userInitials: 'BS', source: '好友分享', enteredAt: '2026-08-07 18:46', leftAt: '2026-08-07 19:01', duration: 900, device: 'Android' }
  ],
  liveInteractionRecords: [
    { recordNo: 'LI2026080709428', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88231007', userName: 'Andi Pratama', userInitials: 'AP', type: '评论', content: '今晚的歌单很好听', occurredAt: '2026-08-07 22:18', status: '有效' },
    ...
    { recordNo: 'LI2026080709104', sessionId: 'LS2608070031', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', userId: '88227653', userName: 'Rizky Maulana', userInitials: 'RM', type: '关注', content: '关注主播', occurredAt: '2026-08-07 21:15', status: '有效' },
    ...
    { recordNo: 'LI2026080708193', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88218339', userName: 'Bima Saputra', userInitials: 'BS', type: '点赞', content: '连续点赞 6 次', occurredAt: '2026-08-07 18:58', status: '有效' }
  ],
  liveGiftRecords: [
    { recordNo: 'GF2026080706421', orderNo: 'CS20260807004218', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88231007', userName: 'Andi Pratama', userInitials: 'AP', giftId: 'GFT1002', giftName: '金色星星', quantity: 2, coins: 1000, occurredAt: '2026-08-07 22:16', status: '有效' },
    ...
    { recordNo: 'GF2026080706104', orderNo: 'CS20260807003604', sessionId: 'LS2608070031', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', userId: '88227653', userName: 'Rizky Maulana', userInitials: 'RM', giftId: 'GFT1003', giftName: '单次幸运礼物', quantity: 10, coins: 100, occurredAt: '2026-08-07 21:12', status: '有效' },
    ...
    { recordNo: 'GF2026080705193', orderNo: 'CS20260807002493', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', userId: '88218339', userName: 'Bima Saputra', userInitials: 'BS', giftId: 'GFT1006', giftName: '咖啡', quantity: 3, coins: 60, occurredAt: '2026-08-07 18:54', status: '有效' }
  ],
  liveCohostRecords: [
    { recordNo: 'CO2026080703418', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', guestId: '77209318', guestName: 'Maya', type: '主播连麦', invitedAt: '2026-08-07 21:40', acceptedAt: '2026-08-07 21:41', endedAt: '2026-08-07 22:05', duration: 1440, result: '正常结束' },
    ...
    { recordNo: 'CO2026080703104', sessionId: 'LS2608070031', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', guestId: '77210411', guestName: 'Sari', type: '主播连麦', invitedAt: '2026-08-07 21:04', acceptedAt: '2026-08-07 21:05', endedAt: '2026-08-07 21:18', duration: 780, result: '主播结束' },
  ...
  hostEarningRecords: [
    { flowNo: 'HE2026080705421', sourceType: '礼物收益', sourceNo: 'CS20260807004218', sessionId: 'LS2608070042', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', grossCoins: 1000, hostCoins: 500, usdAmount: 50, status: '待分成', generatedAt: '2026-08-07 22:17' },
    ...
    { flowNo: 'HE2026080705104', sourceType: '幸运礼物收益', sourceNo: 'CS20260807003604', sessionId: 'LS2608070031', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', grossCoins: 100, hostCoins: 50, usdAmount: 5, status: '待分成', generatedAt: '2026-08-07 21:13' },
  ...
  certifications: [
    ...
    { applicationNo: 'CA202608010019', hostId: '77204002', name: 'Yuni', initials: 'Y', guild: 'Aurora Agency', materials: [{ type: '驾驶证', side: '证件正面', file: 'SIM-Yuni-正面.jpg' }, { type: '驾驶证', side: '证件反面', file: 'SIM-Yuni-反面.jpg' }], identity: { name: 'Yuni Kartika', type: '驾驶证', number: 'SIM-SBY-1109986012', region: 'Surabaya', birthDate: '1998-11-06', age: 27 }, certInfo: '姓名 Yuni Kartika；证件类型 驾驶证；证件号 SIM-SBY-1109986012；地区 Surabaya', submittedAt: '2026-08-01 15:52', status: 'rejected', audit: { result: '审核驳回', reason: '证件已过有效期，请更换有效证件后重新提交', operator: '后台管理员', time: '2026-08-01 18:20' } }
  ],
  livePermissions: [
    { hostId: '77210411', name: 'Sari', initials: 'S', guild: 'Aurora Agency', certStatus: 'approved', liveStatus: 'live', platformPermission: 'enabled', guildPermission: 'enabled', locked: false, reason: '主播认证通过，自动开通', changedAt: '2026-08-04 09:20', changes: [{ before: '未开通', after: '已开通', reason: '主播认证通过，自动开通', operator: '系统', time: '2026-05-12 15:20' }] },
    ...
    { hostId: '77209318', name: 'Maya', initials: 'M', guild: 'Aurora Agency', certStatus: 'approved', liveStatus: 'live', platformPermission: 'enabled', guildPermission: 'enabled', locked: false, reason: '后台管理员恢复直播权限', changedAt: '2026-08-02 10:25', changes: [{ before: '已关闭', after: '已开通', reason: '后台管理员手动恢复', operator: 'Maya Chen', time: '2026-08-02 10:25' }] },
    ...
    { hostId: '77206508', name: 'Intan', initials: 'I', guild: 'Moonlight', certStatus: 'approved', liveStatus: 'offline', platformPermission: 'enabled', guildPermission: 'disabled', locked: false, reason: '公会端临时关闭', changedAt: '2026-07-28 11:36', changes: [{ before: '公会权限已开通', after: '公会权限已关闭', reason: '主播请假', operator: 'Moonlight Agency', time: '2026-07-28 11:36' }] },
  ...
  reports: [
    ...
    { reportNo: 'RA2608010045', violationScope: 'account', reporterId: '88229841', reporterName: 'Nadia Putri', targetType: '主播账号', targetId: '77207152', targetName: 'Ayu', hostId: '77207152', hostName: 'Ayu', hostInitials: 'A', accountRole: '主播', accountStatus: '已封禁', reportType: '其它', evidence: ['私信录屏.mp4'], description: '被举报账号多次发送骚扰私信。', related: '主播账号 77207152', submittedAt: '2026-08-01 18:40', status: 'resolved', result: '封禁账号', record: { action: '封禁账号', reason: '骚扰行为成立', result: '举报成立', execution: '账号已强制下线并禁止登录', reporterNotice: '已发送', targetNotice: '登录拦截页展示', operator: 'Nina', time: '2026-08-01 19:12' } },
    ...
    { reportNo: 'RP2608010039', violationScope: 'live', reporterId: '88229841', reporterName: 'Nadia Putri', targetType: '直播场次', targetId: 'LS2608010054', targetName: 'Ayu 的直播场次', hostId: '77207152', hostName: 'Ayu', hostInitials: 'A', reportType: '其它', evidence: ['直播截图.jpg'], description: '画面中出现站外联系方式。', related: '直播场次 LS2608010054', submittedAt: '2026-08-01 19:04', status: 'resolved', result: '强制关播', record: { action: '强制关播', reason: '站外引流证据明确', result: '举报成立', execution: '当前直播场次已强制结束', reporterNotice: '已发送', targetNotice: '已发送', operator: 'Nina', time: '2026-08-01 19:06' } }
  ],
  giftItems: [
    { id: 'GFT1001', names: { zh: '玫瑰', en: 'Rose', id: 'Mawar', ms: 'Mawar' }, icon: '玫瑰图标', category: 'normal', price: 10, effect: 'rose-light.svga', sort: 100, status: 'online', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-08-01 10:20', changes: [{ action: '编辑礼物', detail: '调整排序权重为 100', operator: '后台管理员', time: '2026-08-01 10:20' }] },
    { id: 'GFT1002', names: { zh: '金色星星', en: 'Golden Star', id: 'Bintang Emas', ms: 'Bintang Emas' }, icon: '金色星星图标', category: 'normal', price: 500, effect: 'gold-star-fullscreen.svga', sort: 90, status: 'online', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-07-28 14:05', changes: [{ action: '绑定特效', detail: 'gold-star-fullscreen.svga', operator: 'Maya Chen', time: '2026-07-28 14:05' }] },
    { id: 'GFT1003', names: { zh: '单次幸运礼物', en: 'Single Lucky Gift', id: 'Hadiah Hoki Tunggal', ms: 'Hadiah Tuah Tunggal' }, icon: '单次幸运礼物图标', category: 'lucky', price: 10, comboCount: 1, unitPrice: 10, targetRtp: 96, effect: 'lucky-single.svga', sort: 80, status: 'online', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-07-25 09:30', rewards: [{ coins: 0, probability: 10.4 }, { coins: 5, probability: 32 }, { coins: 10, probability: 55 }, { coins: 50, probability: 2 }, { coins: 100, probability: 0.5 }, { coins: 1000, probability: 0.1 }], changes: [{ action: '新建礼物', detail: '创建单次幸运礼物配置', operator: '后台管理员', time: '2026-07-25 09:30' }] },
    { id: 'GFT1004', names: { zh: '独立日烟花', en: 'Independence Firework', id: 'Kembang Api Merdeka', ms: 'Bunga Api Merdeka' }, icon: '节日烟花图标', category: 'custom', price: 1000, effect: 'merdeka-firework.svga', sort: 120, status: 'offline', effectiveAt: '2026-08-10 00:00', expiredAt: '2026-08-20 23:59', updatedAt: '2026-08-03 16:45', changes: [{ action: '新建礼物', detail: '配置独立日活动排期', operator: '后台管理员', time: '2026-08-03 16:45' }] },
    { id: 'GFT1005', names: { zh: '音乐皇冠', en: 'Music Crown', id: 'Mahkota Musik', ms: 'Mahkota Muzik' }, icon: '音乐皇冠图标', category: 'custom', price: 300, effect: 'music-crown.svga', sort: 70, status: 'online', effectiveAt: '2026-08-01 00:00', expiredAt: '2026-08-08 23:59', updatedAt: '2026-08-01 00:00', changes: [{ action: '上架', detail: '活动礼物已上架', operator: '系统', time: '2026-08-01 00:00' }] },
    { id: 'GFT1006', names: { zh: '咖啡', en: 'Coffee', id: 'Kopi', ms: 'Kopi' }, icon: '咖啡图标', category: 'normal', price: 20, effect: '未上传', sort: 60, status: 'offline', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-07-20 11:18', changes: [{ action: '下架', detail: '更换图标素材', operator: 'Maya Chen', time: '2026-07-20 11:18' }] },
    { id: 'GFT1007', names: { zh: '幸运连送 10 次', en: 'Lucky Combo 10', id: 'Hoki Beruntun 10', ms: 'Tuah Berturut 10' }, icon: '连送10次幸运礼物图标', category: 'lucky', price: 10, comboCount: 10, unitPrice: 100, targetRtp: 97, effect: 'lucky-combo-10.svga', sort: 75, status: 'offline', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-07-25 09:40', rewards: [{ coins: 0, probability: 8.4 }, { coins: 50, probability: 34 }, { coins: 100, probability: 55 }, { coins: 500, probability: 2 }, { coins: 1000, probability: 0.5 }, { coins: 10000, probability: 0.1 }], changes: [{ action: '新建礼物', detail: '创建连送 10 次幸运礼物', operator: '后台管理员', time: '2026-07-25 09:40' }] },
    { id: 'GFT1008', names: { zh: '幸运连送 100 次', en: 'Lucky Combo 100', id: 'Hoki Beruntun 100', ms: 'Tuah Berturut 100' }, icon: '连送100次幸运礼物图标', category: 'lucky', price: 10, comboCount: 100, unitPrice: 1000, targetRtp: 98, effect: 'lucky-combo-100.svga', sort: 70, status: 'offline', effectiveAt: '-', expiredAt: '-', updatedAt: '2026-07-25 09:45', rewards: [{ coins: 0, probability: 6.4 }, { coins: 500, probability: 36 }, { coins: 1000, probability: 55 }, { coins: 5000, probability: 2 }, { coins: 10000, probability: 0.5 }, { coins: 100000, probability: 0.1 }], changes: [{ action: '新建礼物', detail: '创建连送 100 次幸运礼物', operator: 'Maya Chen', time: '2026-07-25 09:45' }] }
  ],
  giftPurchaseCountRules: [
    { id: 'GSR1001', sendCounts: [1, 10, 20, 50], defaultCount: 1, giftTypes: ['normal', 'custom'], giftIds: ['GFT1001', 'GFT1002', 'GFT1004', 'GFT1005'], status: 'enabled', updatedAt: '2026-08-11 10:30' },
    { id: 'GSR1002', sendCounts: [1, 10, 100], defaultCount: 1, giftTypes: ['lucky'], giftIds: ['GFT1003', 'GFT1007', 'GFT1008'], status: 'enabled', updatedAt: '2026-08-10 18:20' }
  ],
  ticketPriceLevels: [
  ...
  placementItems: [
    { id: 'DSP0003', position: 'live_top', material: 'live-hot-weekly.jpg', jumpType: 'app_page', targetPage: 'live_plaza', detailImage: '未上传', carouselItems: [
      { id: 'CARDSP00031', material: 'live-hot-weekly.jpg', jumpType: 'app_page', targetPage: 'live_plaza', detailImage: '未上传' },
      { id: 'CARDSP00032', material: 'home-merdeka-2026.jpg', jumpType: 'activity_image', targetPage: '', detailImage: 'merdeka-activity-detail-long.jpg' }
    ], startAt: '2026-08-04 00:00', endAt: '2026-08-31 23:59', enabled: true },
    { id: 'DSP0004', position: 'welfare_focus', material: 'lucky-gift-guide.jpg', jumpType: 'activity_image', targetPage: '', detailImage: 'lucky-gift-guide-long.jpg', carouselItems: [
      { id: 'CARDSP00041', material: 'lucky-gift-guide.jpg', jumpType: 'activity_image', targetPage: '', detailImage: 'lucky-gift-guide-long.jpg' },
      { id: 'CARDSP00042', material: 'new-user-recharge.png', jumpType: 'app_page', targetPage: 'recharge', detailImage: '未上传' }
    ], startAt: '2026-08-10 00:00', endAt: '2026-09-10 23:59', enabled: true }
  ],
  pushItems: [
    ...
    { id: 'PSH0002', title: 'Aurora Agency 新主播福利通知', audience: 'guild:G100021', guildName: 'Aurora Agency', content: '公会新主播福利已更新，请进入公会主页查看并及时领取。', linkType: 'internal', linkTarget: '公会主页 / G100021', sendAt: '2026-08-06 12:00', status: 'scheduled', sentCount: 0, readCount: 0, operator: 'Maya Chen', updatedAt: '2026-08-05 11:20' },
    { id: 'PSH0003', title: 'Star House 本周活动安排', audience: 'guild:G100018', guildName: 'Star House', content: '本周公会直播活动安排已经发布，请各位主播及时查看。', linkType: 'internal', linkTarget: '公会主页 / G100018', sendAt: '2026-08-06 19:30', status: 'scheduled', sentCount: 0, readCount: 0, operator: '后台管理员', updatedAt: '2026-08-05 09:45' },
    { id: 'PSH0004', title: 'Blue Ocean 公会分成通知', audience: 'guild:G100014', guildName: 'Blue Ocean', content: '7 月公会分成单已生成，请前往公会端查看。', linkType: 'internal', linkTarget: '分成记录', sendAt: '2026-08-03 09:00', status: 'sent', sentCount: 11, readCount: 9, operator: '后台管理员', updatedAt: '2026-08-03 09:01' },
  ...
  rechargePackageItems: [
    { id: 'RCP1001', cover: 'package-600.png', type: 'regular', price: 14900, purchaseLimit: 0, startAt: '', endAt: '', sort: 100, enabled: true, ios: { enabled: true, productId: 'com.luma.coins.600', productKey: 'starter', productName: '入门金币包', productPrice: 1.49, currency: 'USD', region: '美国', baseCoins: 600, bonus: 0 }, android: { enabled: true, productId: 'coins_600', productKey: 'starter', productName: '入门金币包', productPrice: 1.49, currency: 'USD', region: '美国', baseCoins: 600, bonus: 0 }, updatedAt: '2026-08-05 11:20' },
    { id: 'RCP1002', cover: 'package-1250.png', type: 'regular', price: 29900, purchaseLimit: 0, startAt: '', endAt: '', sort: 90, enabled: true, ios: { enabled: true, productId: 'com.luma.coins.1250', productKey: 'value', productName: '超值金币包', productPrice: 2.99, currency: 'USD', region: '美国', baseCoins: 1250, bonus: 50 }, android: { enabled: true, productId: 'coins_1250', productKey: 'value', productName: '超值金币包', productPrice: 2.99, currency: 'USD', region: '美国', baseCoins: 1250, bonus: 100 }, updatedAt: '2026-08-05 11:18' },
    { id: 'RCP2001', cover: 'summer-package.png', type: 'activity', price: 69900, purchaseLimit: 3, startAt: '2026-08-10 00:00', endAt: '2026-08-18 23:59', sort: 80, enabled: true, ios: { enabled: true, productId: 'com.luma.coins.summer', productKey: 'summer', productName: '夏日金币包', productPrice: 6.99, currency: 'USD', region: '美国', baseCoins: 3200, bonus: 600 }, android: { enabled: true, productId: 'coins_summer', productKey: 'summer', productName: '夏日金币包', productPrice: 6.99, currency: 'USD', region: '美国', baseCoins: 3200, bonus: 800 }, updatedAt: '2026-08-04 18:42' },
    { id: 'RCP2002', cover: 'festival-package.png', type: 'activity', price: 209900, purchaseLimit: 1, startAt: '2026-08-20 00:00', endAt: '2026-08-31 23:59', sort: 70, enabled: false, ios: { enabled: true, productId: 'com.luma.coins.festival', productKey: 'festival', productName: '节日金币包', productPrice: 20.99, currency: 'USD', region: '美国', baseCoins: 10000, bonus: 2000 }, android: { enabled: false, productId: '', productKey: '', productName: '', productPrice: 0, currency: '', region: '', baseCoins: 0, bonus: 0 }, updatedAt: '2026-08-05 09:40' }
  ],
  shareLedgerItems: [
    { ledgerNo: 'SL202608050018', period: '2026-08-05', sourceType: '礼物收益', sourceNo: 'CS20260805003128', sessionId: 'LS2608040018', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', baseAmount: 2860000, platformRatio: 30, platformAmount: 858000, guildRatio: 20, guildAmount: 572000, hostRatio: 50, hostAmount: 1430000, generatedAt: '2026-08-05 12:00', status: 'pending', settlementNo: '-', settledAt: '-' },
    { ledgerNo: 'SL202608050014', period: '2026-08-05', sourceType: '幸运礼物收益', sourceNo: 'CS20260805002716', sessionId: 'LS2608040026', roomId: '710106', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', baseAmount: 1460000, platformRatio: 30, platformAmount: 438000, guildRatio: 20, guildAmount: 292000, hostRatio: 50, hostAmount: 730000, generatedAt: '2026-08-05 11:30', status: 'pending', settlementNo: '-', settledAt: '-' },
    { ledgerNo: 'SL202608040031', period: '2026-08-04', sourceType: '门票收益', sourceNo: 'CS20260804009422', sessionId: 'LS2608020071', roomId: '710028', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', baseAmount: 2680000, platformRatio: 30, platformAmount: 804000, guildRatio: 20, guildAmount: 536000, hostRatio: 50, hostAmount: 1340000, generatedAt: '2026-08-04 23:00', status: 'settled', settlementNo: 'ST202608050008', settledAt: '2026-08-05 09:00' },
    { ledgerNo: 'SL202608040026', period: '2026-08-04', sourceType: '礼物收益', sourceNo: 'CS20260804007635', sessionId: 'LS2608040031', roomId: '710221', hostId: '77208635', hostName: 'Dewi', initials: 'D', guild: 'Star House', baseAmount: 1680000, platformRatio: 30, platformAmount: 504000, guildRatio: 20, guildAmount: 336000, hostRatio: 50, hostAmount: 840000, generatedAt: '2026-08-04 21:00', status: 'settled', settlementNo: 'ST202608050006', settledAt: '2026-08-05 09:00' },
    { ledgerNo: 'SL202608030022', period: '2026-08-03', sourceType: '定制礼物收益', sourceNo: 'CS20260803006418', sessionId: 'LS2608030088', roomId: '710091', hostId: '77206508', hostName: 'Intan', initials: 'I', guild: 'Moonlight', baseAmount: 2140000, platformRatio: 30, platformAmount: 642000, guildRatio: 20, guildAmount: 428000, hostRatio: 50, hostAmount: 1070000, generatedAt: '2026-08-03 23:00', status: 'settled', settlementNo: 'ST202608040011', settledAt: '2026-08-04 09:00' },
    { ledgerNo: 'SL202608030018', period: '2026-08-03', sourceType: '门票收益', sourceNo: 'CS20260803004807', sessionId: 'LS2608040031', roomId: '710221', hostId: '77208635', hostName: 'Dewi', initials: 'D', guild: 'Star House', baseAmount: 920000, platformRatio: 30, platformAmount: 276000, guildRatio: 20, guildAmount: 184000, hostRatio: 50, hostAmount: 460000, generatedAt: '2026-08-03 19:00', status: 'settled', settlementNo: 'ST202608050006', settledAt: '2026-08-05 09:00' },
    { ledgerNo: 'SL202608020009', period: '2026-08-02', sourceType: '礼物收益', sourceNo: 'CS20260802002184', sessionId: 'LS2608010054', roomId: '710145', hostId: '77207152', hostName: 'Ayu', initials: 'A', guild: 'Blue Ocean', baseAmount: 260000, platformRatio: 30, platformAmount: 78000, guildRatio: 20, guildAmount: 52000, hostRatio: 50, hostAmount: 130000, generatedAt: '2026-08-02 09:00', status: 'settled', settlementNo: 'ST202608020014', settledAt: '2026-08-02 10:00' }
  ],
  settlementRecords: [
    { settlementNo: 'ST202608050008', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', periodStart: '2026-08-01', periodEnd: '2026-08-04', amount: 1782000, method: '银行转账', bank: 'Bank Central Asia', accountName: 'Sari Wulandari', accountNo: '0147283910', voucher: 'ST202608050008-付款凭证.jpg', settledAt: '2026-08-05 09:00', operator: '后台管理员', createdAt: '2026-08-05 09:06', note: '8 月第一期主播收益分成', ledgerNos: ['SL202608040031'] },
    { settlementNo: 'ST202608050006', hostId: '77208635', hostName: 'Dewi', initials: 'D', guild: 'Star House', periodStart: '2026-08-03', periodEnd: '2026-08-04', amount: 1584000, method: '银行转账', bank: 'Bank Mandiri', accountName: 'Dewi Lestari', accountNo: '1320098417265', voucher: 'ST202608050006-付款凭证.jpg', settledAt: '2026-08-05 09:00', operator: 'Maya Chen', createdAt: '2026-08-05 09:04', note: '合并两笔分成记录分成', ledgerNos: ['SL202608040026', 'SL202608030018'] },
    { settlementNo: 'ST202608040011', hostId: '77206508', hostName: 'Intan', initials: 'I', guild: 'Moonlight', periodStart: '2026-08-03', periodEnd: '2026-08-03', amount: 1089000, method: '银行转账', bank: 'Bank Negara Indonesia', accountName: 'Intan Permata', accountNo: '0918842056', voucher: 'ST202608040011-付款凭证.jpg', settledAt: '2026-08-04 09:00', operator: '后台管理员', createdAt: '2026-08-04 09:08', note: '-', ledgerNos: ['SL202608030022'] },
    { settlementNo: 'ST202608020014', hostId: '77207152', hostName: 'Ayu', initials: 'A', guild: 'Blue Ocean', periodStart: '2026-08-01', periodEnd: '2026-08-01', amount: 148500, method: '电子钱包', bank: 'GoPay', accountName: 'Ayu Safitri', accountNo: '081377260519', voucher: 'ST202608020014-付款凭证.jpg', settledAt: '2026-08-02 10:00', operator: 'Maya Chen', createdAt: '2026-08-02 10:05', note: '-', ledgerNos: ['SL202608020009'] }
  ],
  hostSettlementUploads: [
    { id: 'HSR20260720001', month: '2026-07', entityCount: 3, totalAmount: 1590000, settler: 'Dimas Putra', settlementDate: '2026-08-20', remark: '2026 年 7 月主播分成', uploader: 'Maya Chen', uploadedAt: '2026-08-20 20:10:10', fileName: 'host-settlement-2026-07.xlsx', details: [
      { name: 'Sari', id: '77210411', guildName: 'Aurora Agency', guildId: 'G100021', amount: 620000 },
    ...
    { id: 'HSR20260618002', month: '2026-06', entityCount: 3, totalAmount: 1485000, settler: 'Dimas Putra', settlementDate: '2026-07-18', remark: '2026 年 6 月主播分成', uploader: '后台管理员', uploadedAt: '2026-07-18 18:42:16', fileName: 'host-settlement-2026-06.xlsx', details: [
      { name: 'Maya', id: '77209318', guildName: 'Aurora Agency', guildId: 'G100021', amount: 545000 },
    ...
    { id: 'HSR20260519003', month: '2026-05', entityCount: 3, totalAmount: 1378000, settler: 'Maya Chen', settlementDate: '2026-06-19', remark: '2026 年 5 月主播分成', uploader: 'Dimas Putra', uploadedAt: '2026-06-19 16:28:35', fileName: 'host-settlement-2026-05.xlsx', details: [
      { name: 'Sari', id: '77210411', guildName: 'Aurora Agency', guildId: 'G100021', amount: 518000 },
  ...
  guildSettlementUploads: [
    { id: 'GSR20260720001', month: '2026-07', entityCount: 3, totalAmount: 90000, settler: 'Dimas Putra', settlementDate: '2026-08-20', remark: '2026 年 7 月公会分成', uploader: 'Maya Chen', uploadedAt: '2026-08-20 20:10:10', fileName: 'guild-settlement-2026-07.xlsx', details: [
      { name: 'Aurora Agency', id: 'G100021', amount: 38000 },
    ...
    { id: 'GSR20260618002', month: '2026-06', entityCount: 3, totalAmount: 84200, settler: 'Dimas Putra', settlementDate: '2026-07-18', remark: '2026 年 6 月公会分成', uploader: '后台管理员', uploadedAt: '2026-07-18 18:45:02', fileName: 'guild-settlement-2026-06.xlsx', details: [
      { name: 'Aurora Agency', id: 'G100021', amount: 35200 },
    ...
    { id: 'GSR20260519003', month: '2026-05', entityCount: 3, totalAmount: 78600, settler: 'Maya Chen', settlementDate: '2026-06-19', remark: '2026 年 5 月公会分成', uploader: 'Dimas Putra', uploadedAt: '2026-06-19 16:32:48', fileName: 'guild-settlement-2026-05.xlsx', details: [
      { name: 'Aurora Agency', id: 'G100021', amount: 32600 },
      { name: 'Blue Ocean', id: 'G100014', amount: 24800 },
      { name: 'Moonlight', id: 'G100009', amount: 21200 }
    ] }
  ],
  guilds: [
    { id: 'G100021', name: 'Aurora Agency', description: '专注音乐与才艺主播运营。', leaderId: '88240016', leaderName: 'Rani Hartono', leaderStatus: 'enabled', hostCount: 18, earnings: 182600000, status: 'enabled', createdAt: '2026-03-18 10:20', dissolutionCheck: { pendingHostCount: 18, unsettledShareCount: 1, unnotifiedHostCount: 18 } },
    { id: 'G100018', name: 'Star House', description: '综合娱乐直播公会。', leaderId: '88239208', leaderName: 'Bagus Santoso', leaderStatus: 'enabled', hostCount: 24, earnings: 236800000, status: 'enabled', createdAt: '2026-03-05 14:12', dissolutionCheck: { pendingHostCount: 24, unsettledShareCount: 0, unnotifiedHostCount: 24 } },
    { id: 'G100014', name: 'Blue Ocean', description: '舞蹈与聊天主播运营。', leaderId: '88237011', leaderName: 'Nina Sari', leaderStatus: 'disabled', hostCount: 11, earnings: 84600000, status: 'disabled', createdAt: '2026-02-22 09:35', dissolutionCheck: { pendingHostCount: 11, unsettledShareCount: 0, unnotifiedHostCount: 0 } },
    { id: 'G100009', name: 'Moonlight', description: '音乐类主播孵化与运营。', leaderId: '88235187', leaderName: 'Dimas Putra', leaderStatus: 'enabled', hostCount: 9, earnings: 62300000, status: 'enabled', createdAt: '2026-02-08 16:48', dissolutionCheck: { pendingHostCount: 9, unsettledShareCount: 0, unnotifiedHostCount: 9 } },
    { id: 'G100003', name: 'Sunrise Club', description: '历史业务已结清。', leaderId: '88231866', leaderName: 'Rika Dewi', leaderStatus: 'disabled', hostCount: 0, earnings: 21800000, status: 'disabled', createdAt: '2026-01-12 11:06', dissolutionCheck: { pendingHostCount: 0, unsettledShareCount: 0, unnotifiedHostCount: 0 } }
  ],
  hostAccountBalances: [
    { hostId: '77210411', hostName: 'Sari', guildId: 'G100021', guildName: 'Aurora Agency', balance: 4820000 },
    { hostId: '77208635', hostName: 'Dewi', guildId: 'G100018', guildName: 'Star House', balance: 3160000 },
    { hostId: '77209318', hostName: 'Maya', guildId: 'G100021', guildName: 'Aurora Agency', balance: 2410000 },
    { hostId: '77207152', hostName: 'Ayu', guildId: 'G100014', guildName: 'Blue Ocean', balance: 920000 },
    { hostId: '77206508', hostName: 'Intan', guildId: 'G100009', guildName: 'Moonlight', balance: 1780000 },
    { hostId: '77205884', hostName: 'Lala', guildId: 'G100018', guildName: 'Star House', balance: 0 }
  ],
  hostBalanceChanges: {
    '77210411': [
      { recordNo: 'HBC2026081800128', type: '收益分成', direction: 'in', amount: 1000000, balanceBefore: 3820000, balanceAfter: 4820000, operator: '系统', remark: '2026 年 7 月主播分成记录导入增加', createdAt: '2026-08-18 10:22:16' },
  ...
  guildBalanceChanges: {
    'G100021': [
      ...
      { recordNo: 'GBC2026080100009', type: '收益分成', direction: 'in', amount: 13040000, balanceBefore: 0, balanceAfter: 13040000, operator: '系统', remark: '2026 年 6 月公会分成记录导入增加', createdAt: '2026-08-01 09:12:30' }
    ],
    'G100018': [
    ...
    'G100003': [
      { recordNo: 'GBC2026081200019', type: '分成修正', direction: 'out', amount: 5000000, balanceBefore: 5000000, balanceAfter: 0, operator: 'Dimas Putra', remark: '历史公会分成结清修正', createdAt: '2026-08-12 16:20:08' },
  ...
  guildAccountBalances: [
    { guildId: 'G100021', guildName: 'Aurora Agency', balance: 18840000 },
    { guildId: 'G100018', guildName: 'Star House', balance: 25400000 },
    { guildId: 'G100014', guildName: 'Blue Ocean', balance: 6800000 },
    { guildId: 'G100009', guildName: 'Moonlight', balance: 12400000 },
    { guildId: 'G100003', guildName: 'Sunrise Club', balance: 0 }
  ],
  system: {
    accounts: [
    ...
    roles: [
      { id: 'ROLE001', name: '超级管理员', permissionCount: 39, dataScope: '全平台', status: 'enabled', accountCount: 1, createdAt: '2026-01-10 10:00', updatedAt: '2026-01-10 10:00', locked: true },
    ...
    permissions: [
      { group: '工作台', items: [] },
      { group: '用户管理', items: [] },
      { group: '主播管理', items: ['主播审核', '主播列表', '直播场次', '巡房排班', '内容审核'] },
      { group: '举报处理', items: ['账号违规', '直播间违规', '违规类型'] },
      { group: '公会管理', items: ['公会列表'] },
      { group: '礼物道具', items: ['普通礼物', '定制礼物', '幸运礼物', '道具配置', '购买份数配置'] },
      { group: '运营配置', items: ['展位配置', '推送管理', '充值套餐', '任务配置', '公会推荐', '直播类型', '直播房型', '敏感词库'] },
      { group: '订单管理', items: ['充值订单', '消费订单', '退款订单'] },
      { group: '财务分成', items: ['主播分成记录', '主播账户余额', '公会分成记录', '公会账户余额'] },
      { group: '数据分析', items: ['数据概览', '报表中心'] },
      { group: '运营账号', items: ['账号列表', '发放记录', '送礼记录', '额度限制'] },
      { group: '系统配置', items: ['后台账号', '角色管理'] }
    ],
    parameters: [
      ...
      { id: 'PARAM006', category: '收益配置', code: 'lucky.earning.rate', name: '幸运礼物收益比例', value: '1%', valueType: 'percent', rawValue: 1, unit: '%', status: 'enabled', effectiveAt: '2026-08-10 00:00', updatedAt: '2026-08-06 17:05', operator: 'Maya Chen', description: '幸运礼物价格计入主播收益的比例。' },
  ...
  analytics: {
    ...
    hostPerformanceStatistics: [
      { date: '2026-08-19', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', giftRevenue: 4860, giftCount: 12840, liveMinutes: 226, sessions: 2, effectiveDays: 1 },
      ...
      { date: '2026-08-19', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', giftRevenue: 3680, giftCount: 9240, liveMinutes: 184, sessions: 1, effectiveDays: 1 },
      ...
      { date: '2026-08-18', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', giftRevenue: 4520, giftCount: 11920, liveMinutes: 205, sessions: 1, effectiveDays: 1 },
      ...
      { date: '2026-08-18', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', giftRevenue: 3420, giftCount: 8650, liveMinutes: 176, sessions: 1, effectiveDays: 0 },
      ...
      { date: '2026-08-17', hostId: '77210411', hostName: 'Sari', initials: 'S', guild: 'Aurora Agency', giftRevenue: 5180, giftCount: 13620, liveMinutes: 260, sessions: 2, effectiveDays: 1 },
      ...
      { date: '2026-08-17', hostId: '77209318', hostName: 'Maya', initials: 'M', guild: 'Aurora Agency', giftRevenue: 3860, giftCount: 9680, liveMinutes: 205, sessions: 1, effectiveDays: 1 },
    ...
    financeReconciliation: {
      monthlyIncomeExpense: [
        { month: '2026-08', totalRevenue: 1795000, userRechargeAmount: 119800, userRefundAmount: 1920 },
        { month: '2026-07', totalRevenue: 1656000, userRechargeAmount: 110400, userRefundAmount: 1400 },
        { month: '2026-06', totalRevenue: 1518000, userRechargeAmount: 102600, userRefundAmount: 960 }
      ],
      monthlyHostShare: [
        { month: '2026-08', hostId: '77210411', hostName: 'Sari', guildId: 'G100021', guildName: 'Aurora Agency', effectiveDays: 18, liveSessions: 24, monthlyRevenue: 486000, normalGift: 256000, customGift: 90000, luckyGift: 80000, ticket: 60000 },
        { month: '2026-08', hostId: '77209318', hostName: 'Maya', guildId: 'G100021', guildName: 'Aurora Agency', effectiveDays: 16, liveSessions: 21, monthlyRevenue: 368000, normalGift: 188000, customGift: 70000, luckyGift: 65000, ticket: 45000 },
        ...
        { month: '2026-07', hostId: '77210411', hostName: 'Sari', guildId: 'G100021', guildName: 'Aurora Agency', effectiveDays: 25, liveSessions: 34, monthlyRevenue: 448000, normalGift: 238000, customGift: 80000, luckyGift: 75000, ticket: 55000 }
      ],
      monthlyHostEarnings: [
      ...
      consumptionOrderDetail: [
        { viewerId: '88231007', viewerName: 'Andi Pratama', productType: '普通礼物', productId: 'GFT1002', productName: '金色星星', unitPrice: 500, quantity: 2, consumptionCoins: 1000, hostEarnings: 500, hostId: '77210411', hostName: 'Sari', guildId: 'G100021', guildName: 'Aurora Agency', sessionId: 'LS2608200089', consumedAt: '2026-08-20 20:10:10' },
        { viewerId: '88229841', viewerName: 'Nadia Putri', productType: '幸运礼物', productId: 'GFT1007', productName: '幸运礼物 10 连送', unitPrice: 100, quantity: 1, consumptionCoins: 100, hostEarnings: 50, hostId: '77209318', hostName: 'Maya', guildId: 'G100021', guildName: 'Aurora Agency', sessionId: 'LS2608200076', consumedAt: '2026-08-20 19:42:18' },
        ...
        { viewerId: '88218339', viewerName: 'Bima Saputra', productType: '门票', productId: 'TICKET-300', productName: '粉丝专属演出门票', unitPrice: 300, quantity: 1, consumptionCoins: 300, hostEarnings: 150, hostId: '77210411', hostName: 'Sari', guildId: 'G100021', guildName: 'Aurora Agency', sessionId: 'LS2607310072', consumedAt: '2026-07-31 20:14:09' }
      ],
      refundOrderDetail: [
    ...
    hosts: [
      ...
      { id: '77209318', name: 'Maya', guild: 'Aurora Agency', viewerEntries: 4860, bounce10Users: 1171, bounce5mUsers: 1876, watchSeconds: 3363120, viewers: 4400, interactingUsers: 1311, giftUsers: 414, bounce10: 24.1, bounce5m: 38.6, stay: 692, peak: 940, interaction: 29.8, giftConversion: 9.4, followers: 1260, dailyLiveMinutes: { '2026-08-01': 184, '2026-08-02': 160, '2026-08-03': 205, '2026-08-04': 190, '2026-08-05': 176, '2026-08-06': 184, '2026-08-07': 184 } },
    ...
    lives: [
      { sessionId: 'LS2608070042', hostId: '77210411', host: 'Sari', guild: 'Aurora Agency', roomType: '普通房', startAt: '2026-08-07 19:30', duration: 226, peak: 1280, viewers: 6840, cohostCount: 5, cohostDuration: 74 },
      ...
      { sessionId: 'LS2608070031', hostId: '77209318', host: 'Maya', guild: 'Aurora Agency', roomType: '普通房', startAt: '2026-08-07 17:20', duration: 184, peak: 940, viewers: 4860, cohostCount: 4, cohostDuration: 58 },
    ...
    earnings: [
      { rank: 1, id: '77210411', name: 'Sari', type: '主播', guild: 'Aurora Agency', earnings: 328600, platformShare: 98580, guildShare: 65720, subjectShare: 164300 },
      ...
      { rank: 3, id: '77209318', name: 'Maya', type: '主播', guild: 'Aurora Agency', earnings: 248600, platformShare: 74580, guildShare: 49720, subjectShare: 124300 },
  ...
  guildRecords: {
    'G100021': {
      hosts: [{ id: '77210411', name: 'Sari', level: 38, earnings: 32860000, joinedAt: '2026-05-18 10:26', livePermission: '正常' }, { id: '77209318', name: 'Maya', level: 27, earnings: 18650000, joinedAt: '2026-06-12 14:08', livePermission: '关闭' }],
...
(() => {
  ...
  const propZhNames = {
    PRP2001: '银色头像框', PRP2002: '海洋气泡', PRP2003: '音乐勋章', PRP2004: '夏日头衔',
    PRP2005: '粉丝灯牌', PRP2006: '皇家座驾', PRP2007: '星光灯牌', PRP2008: '心形灯牌',
    PRP2009: '皇冠灯牌', PRP2010: '新人之星', PRP2011: '人气之王', PRP2012: '守护者',
    PRP2013: '礼物达人', PRP2014: '直播先锋', PRP2015: '社区之星', PRP2016: '黄金跑车',
    PRP2017: '天空飞艇', PRP2018: '梦想火箭', PRP2019: '星光气泡', PRP2020: '心形气泡',
    PRP2021: '霓虹气泡', PRP2022: '星光头像框', PRP2023: '皇冠头像框', PRP2024: '黑金头像框'
  };
  const pushTranslations = {
    PSH0001: {
      titles: { zh: '独立日活动已开启', en: 'Independence Day Event Is Live', id: 'Acara Hari Kemerdekaan Telah Dimulai', ms: 'Acara Hari Kemerdekaan Telah Bermula' },
      contents: { zh: '独立日庆典活动已开启，完成任务可领取限定奖励。', en: 'The Independence Day celebration is live. Complete tasks to claim limited rewards.', id: 'Perayaan Hari Kemerdekaan telah dimulai. Selesaikan tugas untuk mendapatkan hadiah terbatas.', ms: 'Sambutan Hari Kemerdekaan telah bermula. Selesaikan tugasan untuk mendapatkan ganjaran terhad.' }
    },
    PSH0002: {
      titles: { zh: 'Aurora Agency 新主播福利通知', en: 'Aurora Agency New Host Benefits', id: 'Benefit Host Baru Aurora Agency', ms: 'Manfaat Hos Baharu Aurora Agency' },
      contents: { zh: '公会新主播福利已更新，请进入公会主页查看并及时领取。', en: 'New host benefits have been updated. Visit the guild page to claim them.', id: 'Benefit host baru telah diperbarui. Buka halaman guild untuk mengambilnya.', ms: 'Manfaat hos baharu telah dikemas kini. Buka halaman guild untuk menuntutnya.' }
    },
    PSH0003: {
      titles: { zh: 'Star House 本周活动安排', en: 'Star House Weekly Event Schedule', id: 'Jadwal Acara Mingguan Star House', ms: 'Jadual Acara Mingguan Star House' },
      contents: { zh: '本周公会直播活动安排已经发布，请各位主播及时查看。', en: 'This week\'s guild live event schedule is available. Please review it.', id: 'Jadwal acara live guild minggu ini telah tersedia. Silakan periksa.', ms: 'Jadual acara live guild minggu ini telah tersedia. Sila semak.' }
    },
    PSH0004: {
      titles: { zh: 'Blue Ocean 公会分成通知', en: 'Blue Ocean Guild Revenue Share Notice', id: 'Pemberitahuan Bagi Hasil Guild Blue Ocean', ms: 'Notis Perkongsian Hasil Guild Blue Ocean' },
      contents: { zh: '7 月公会分成单已生成，请前往公会端查看。', en: 'The July guild revenue share statement is ready. View it in the guild portal.', id: 'Laporan bagi hasil guild bulan Juli telah dibuat. Lihat di portal guild.', ms: 'Penyata perkongsian hasil guild bulan Julai telah dibuat. Lihat di portal guild.' }
    },
    PSH0005: {
      titles: { zh: '幸运礼物玩法即将上线通知', en: 'Lucky Gift Coming Soon', id: 'Fitur Lucky Gift Segera Hadir', ms: 'Ciri Lucky Gift Akan Datang' },
      contents: { zh: '幸运礼物新玩法即将上线，更多活动内容将在福利中心公布。', en: 'Lucky Gift is coming soon. More details will be announced in the Benefits Center.', id: 'Fitur Lucky Gift segera hadir. Detail lainnya akan diumumkan di Pusat Benefit.', ms: 'Ciri Lucky Gift akan datang. Maklumat lanjut akan diumumkan di Pusat Manfaat.' }
    }
  };
  ...
  mock.pushItems.forEach((item) => {
    ...
    item.titles = { zh: item.title, en: '', id: '', ms: '', ...(translation.titles || {}), ...(item.titles || {}) };
    item.contents = { zh: item.content, en: '', id: '', ms: '', ...(translation.contents || {}), ...(item.contents || {}) };
    item.title = item.titles.zh;
    item.content = item.contents.zh;
  });
  ...
  mock.hostAccountBalances.forEach((item) => convert(item, ['balance']));
  ...
  mock.guildAccountBalances.forEach((item) => convert(item, ['balance']));
